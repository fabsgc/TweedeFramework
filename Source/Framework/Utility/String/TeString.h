...
{
    template <typename T>
    using BasicString = std::basic_string <T, std::char_traits<T>, StdAllocator<T>>;

    /**	\brief Basic string stream that uses Banshee memory allocators. */
    template <typename T>
    using BasicStringStream = std::basic_stringstream <T, std::char_traits<T>, StdAllocator<T>>;
    ...
    template <typename T>
    using BasicIStringStream = std::basic_istringstream<T, std::char_traits<T>, StdAllocator<T>>;
